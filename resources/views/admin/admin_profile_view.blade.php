            ...
            <li class="nav-item ">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('admin.forgetpassword')}}">Forgot Password</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Other Pages:</h6>
                        <a class="collapse-item" href="{{route('admin.404')}}">404 Page</a>
                        <a class="collapse-item active" href="{{route('admin.blank')}}">Blank Page</a>
                    </div>
                </div>
            </li>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-8 d-flex flex-column align-items-center">
              <img src="{{(!empty($profileData->photo))? url('upload/admin_images/'.$profileData->photo):url('upload/no_images.jpeg')}}" alt="Profile" class= "img-profile rounded-circle"  width="100" height="100">
              <h1>{{$profileData->name}}</h1>
              <h2>System Programmer</h2>
          ...
          <div class="card">
            <div class="card-body pt-3">
              <!-- Bordered Tabs -->
                  ...
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit" aria-selected="false" role="tab" text-align ="center" >Edit Profile</button>
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="eamil" class="form-control" id="email" value="{{$profileData ->email}}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label for="Email" class="col-md-4 col-lg-3 col-form-label">Photo</label>
                      <div class="col-md-8 col-lg-9">
